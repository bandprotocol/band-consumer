...
var (
	_ simapp.App              = (*BandConsumerApp)(nil)
	_ servertypes.Application = (*BandConsumerApp)(nil)
)

// BandConsumerApp extends an ABCI application, but with most of its parameters exported.
// They are exported for convenience in creating helper functions, as object
// capabilities aren't needed for testing.
type BandConsumerApp struct { // nolint: golint
	*baseapp.BaseApp
...
func NewBandConsumerApp(
	...
	homePath string,
	invCheckPeriod uint,
	encodingConfig bcappparams.EncodingConfig,
	...
	keys := sdk.NewKVStoreKeys(
		...
		capabilitytypes.StoreKey, authzkeeper.StoreKey, feegrant.StoreKey, consumingtypes.StoreKey,
	)
	...
	app.mm.SetOrderEndBlockers(crisistypes.ModuleName, govtypes.ModuleName, authz.ModuleName, feegrant.ModuleName, stakingtypes.ModuleName)
	...
	app.mm.SetOrderInitGenesis(
		...
		slashingtypes.ModuleName, govtypes.ModuleName, authz.ModuleName, minttypes.ModuleName, crisistypes.ModuleName,
		ibchost.ModuleName, genutiltypes.ModuleName, evidencetypes.ModuleName, consumingtypes.ModuleName, ibctransfertypes.ModuleName, feegrant.ModuleName,
	)
...
func (app *BandConsumerApp) BlockedAddrs() map[string]bool {
...
func (app *BandConsumerApp) LegacyAmino() *codec.LegacyAmino {
...
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *BandConsumerApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Gaia's InterfaceRegistry
func (app *BandConsumerApp) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *BandConsumerApp) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *BandConsumerApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *BandConsumerApp) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *BandConsumerApp) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *BandConsumerApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *BandConsumerApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *BandConsumerApp) RegisterTendermintService(clientCtx client.Context) {
